...
resuelta) → 002-build → 006-reframe → 005-guías. 007 y 008
...
| 4   | 006 social graduation spike                                                  | spike      | BLOCKED — premisa invertida (flag `true` desde 2026-09-14, verificado vía API 2026-09-17: 3 plataformas, 3 posts opt-in); va por reframe/auditoría, no ADR-0012 |
...
| 8   | Builds 007 (003-build) y 008 (001-build)                                     | build      | DONE (007 vía PR #176, 008 vía PR #179; ambos 2026-09-16)                                                                                                       |
...
| 006  | reframe 006 (auditoría retroactiva en vez de ADR-0012) | BLOCKED (premisa invertida verificada 2026-09-17) | —                                      | —                                         | flag `true` + 3 plataformas + 3 opt-in; falta decisión de reframe                           | —            |
...
| 006  | Publisher piloto con freno (`SOCIAL_PUBLISH_ENABLED` off) y sin observabilidad (premisa invertida 2026-09-17: flag `true`, 3 plataformas, 3 opt-in) | —                    | reframe/auditoría (en vez de 0012) | —     | —             |
