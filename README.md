...
- [`docs/backlog/source-of-truth-backlog.md`](docs/backlog/source-of-truth-backlog.md): historical follow-up backlog from that audit; current plan statuses live in the backend's [`plans/README.md`](https://github.com/cortega26/noticiencias_news_collector/blob/main/plans/README.md).
