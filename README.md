...
- [`docs/backlog/source-of-truth-backlog.md`](docs/backlog/source-of-truth-backlog.md): historical follow-up backlog from that audit; current plan statuses live in the backend's [`../noticiencias_news_collector/plans/README.md`](../noticiencias_news_collector/plans/README.md).
