...
Los eventos que registramos, además de las visitas a páginas, son: el envío del formulario del boletín (solo el hecho del envío; nunca tu correo), los clics en los enlaces a las fuentes originales de un artículo, haber leído hasta el 75 % de un artículo y las búsquedas que haces en el sitio. **El texto que escribes en el buscador se envía a Google Analytics**, así que te pedimos no escribir en él datos personales.
